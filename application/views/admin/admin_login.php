...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url('resources/admin/login/css/style.css')?>">">
...
<body>
    ...
    <div class="login">
      ...
      <div class="login__form">
        <div class="login__row">
          <h1 style="color: red; background: rgba(255,255,255, .6); font-weight: 800;" id="error" hidden>Error de usuario y/o contraseña.</h1>
          <svg class="login__icon name svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
          </svg>
          <input type="text" id="login_user" class="login__input name" placeholder="Username"/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
          <input type="password" id="login_password" class="login__input pass" placeholder="Password"/>
        </div>
        <button type="button" id="login_button" class="login__submit">Accesar</button>
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
    ...
    <script src="<?=base_url('resources/admin/login/js/script.js')?>">"></script>
    <script src="<?=base_url('resources/admin/login/js/login.js')?>">"></script>
