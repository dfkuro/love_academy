...
<div class="row lac-row-padding">
  <div class="col-xs-12">
    <span>CHOOSE YOU TYPE OF EVENT</span>
  ...
  <div class="col-xs-12">
    ...
    <div class="row lac-row-padding">
      ...
      <div class="col-xs-8">
        ...
        <div class="form-hide form-workshop" hidden>
          <div class="row" >
            
            <div class="col-xs-12">
              <h2 class="title-text" style="padding-bottom: 10px; border-bottom: 3px solid #000;">WORKSHOP FORM</h2>
            </div>
      ...
      <div class="col-xs-8">
        ...
        <div class="form-hide form-signature" hidden>

          <div class="row">
            
            <div class="col-xs-12">
              <h2 class="title-text" style="padding-bottom: 10px; border-bottom: 3px solid #000;">SIGNATURE EVENT</h2>
            </div>
      ...
      <!-- Section for the newsletter form -->
