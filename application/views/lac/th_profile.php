        ...
        <form>
          <div class="form-group">
            <div class="col-xs-3" style="padding-left: 0; padding-right: 0;">
              <img src="<?=base_url('love_academy_files/users/avatars/'.$th_info['avatar'])?>" class="img-responsive" style="width: 250px; height: 250px; border: 1px solid #000;" readonly>
              <!-- <p class="help-block text-center">UPLOAD IMAGE</p> -->
            </div>
            <div class="col-xs-9" style="">
              <input type="email" class="form-control" id="email" value="<?=$th_info['name']?>" readonly>
              <br>
              <textarea type="email" class="form-control" id="email" style="height: 142px; background-color: transparent;" readonly><?=$th_info['bio']?></textarea>
            </div>
          </div>
        </form>
      </div>
