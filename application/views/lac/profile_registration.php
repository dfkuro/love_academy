    ...
    <div class="row lac-row-padding">
      ...
      <div class="col-xs-8">
        <div class="row">
          ...
          <div class="col-xs-12">
            <h2 class="title-text" id="registration_title" style="padding-bottom: 10px; border-bottom: 3px solid #000;">REGISTRATION (PROFILE)</h2>
          </div>
          ...
          <div class="col-xs-12">
            <form role="form" id="form_new_user" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" name="heard_about">
              </div>
